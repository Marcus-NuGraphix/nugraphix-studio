...
export const Route = createFileRoute('/admin/workspaces/operations/users/$userId')({
  loader: async ({ params }) => {
  ...
  return (
    <section className="space-y-6">
      <PageHeader
        ...
        actions={
          <Button variant="outline" asChild>
            <Link to="/admin/workspaces/operations/users">
      ...
      <div className="grid gap-2 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <Button variant="outline" asChild>
          <Link to="/admin/workspaces/operations/users">Return to Directory</Link>
        </Button>
      </div>
        ...
        onDelete={() => {
          ...
          void runMutation(
            async () => {
              ...
              await navigate({ to: '/admin/workspaces/operations/users' })
            },
